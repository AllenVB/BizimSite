...
const ResidentHome = () => {
  return (
    <div className="p-4 md:p-8 min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-orange-500">
          ...
          <p className="text-2xl md:text-3xl font-bold text-gray-900">₺450.00</p>
