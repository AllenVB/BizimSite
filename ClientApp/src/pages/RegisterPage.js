        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl mb-4 shadow-lg">
            <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m0 0h3m-6-9a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h1 className="text-4xl font-bold text-gray-900">BizimSite</h1>
          <p className="mt-2 text-gray-600 text-lg">Yeni hesap oluşturun</p>
        </div>
          ...
          <div className="p-8">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="ad" className="block text-sm font-semibold text-gray-700 mb-2">
                    Ad
                  </label>
                  <input
                    id="ad"
                ...
                <div>
                  <label htmlFor="soyad" className="block text-sm font-semibold text-gray-700 mb-2">
                    Soyad
                  </label>
                  <input
                    id="soyad"
              ...
              <div>
                <label htmlFor="sifreOnay" className="block text-sm font-semibold text-gray-700 mb-2">
                  Şifre Tekrar
                </label>
                <input
                  id="sifreOnay"
            ...
            <div className="mt-6 relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Zaten hesabınız var?</span>
              </div>
            </div>
